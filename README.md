...
5. Database connectivity:
   - Default profile **h2** (runs out-of-the-box, no setup needed)
   - Profile **mssql** for Local MSSQL (DB name: `TESTDB`)
6. 1 GET API with Pagination (10 records per page)
...
- `postman/InterviewAssignment.postman_collection.json`
